          ...
          <g transform="translate(825.000000, 1100.000000)">
            ...
            >
              ...
              >
                ...
                <mask fill="white" id="react-mask-110">
                  <use xlinkHref="#react-path-109" />
                </mask>
                <use
                  fill="#B7C1DB"
                  fillRule="evenodd"
                  id="Hoodie"
                  xlinkHref="#react-path-109"
                />
                <g
                  fill="#B1E2FF"
                  fillRule="evenodd"
              ...
              >
                ...
                <g fillOpacity="0.599999964" id="Eyebrow/Outline/Default">
              ...
              <g fillRule="evenodd" id="Top" strokeWidth="1">
                <defs>
                  <rect
                    height="280"
                    id="react-path-95"
                ...
                <mask fill="white" id="react-mask-93">
                  <use xlinkHref="#react-path-95" />
                </mask>
                <g id="Mask" />
                <g id="Top/Short-Hair/Short-Round" mask="url(#react-mask-93)">
                  <g transform="translate(-1.000000, 0.000000)">
                    <mask fill="white" id="react-mask-92">
                      <use xlinkHref="#react-path-94" />
                    </mask>
                    <use
                      fill="#28354B"
                      fillRule="evenodd"
                      id="Short-Hair"
                      stroke="none"
                      xlinkHref="#react-path-94"
                    />
                    <g
                      fill="#B58143"
                      id="Skin/👶🏽-03-Brown"
                      mask="url(#react-mask-92)"
                    >
                      <g id="Color" transform="translate(0.000000, 0.000000) ">
                        <rect height="280" width="264" x="0" y="0" />
                      </g>
